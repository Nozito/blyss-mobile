        ...
        {mapped.map((item) =>
          ...
          !item.address_visible && item.service_radius_km ? (
            <Circle
              ...
              strokeWidth={1.5}
              fillColor={withAlpha(colors.primary, 0.13)}
            />
          ) : null
        )}
        {mapped.map((item) => (
...
function createStyles(colors: ReturnType<typeof useThemeColors>) {
  return StyleSheet.create({
    ...
    clusterText: { color: "#FFFFFF", fontWeight: "700", fontSize: 14 },
    ...
    pinCircle: {
      ...
      borderWidth: 2.5, borderColor: colors.primary, backgroundColor: withAlpha(colors.primary, 0.15),
      shadowColor: colors.primary, shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.4, shadowRadius: 4, elevation: 4,
    },
    pinFallback: { flex: 1, alignItems: "center", justifyContent: "center", backgroundColor: withAlpha(colors.primary, 0.15) },
    ...
    cardAvatar: {
      width: 56, height: 56, borderRadius: 28, backgroundColor: withAlpha(colors.primary, 0.15),
    ...
    noMarkersCard: {
      ...
      backgroundColor: withAlpha(colors.card, 0.95), borderRadius: 20,
